            ...
            <div class="widget-body">
                <div id="uiform-listform-options">
                    <div class="uiform-listform-options-col">
                       ...
                       href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform';?>">
                        <i class="fa fa-plus">
                        </i>
...
<?php foreach ($query as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" onclick="javascript:rocketform.form_getcode(<?php echo $row->fmb_id;?>);" class="btn btn-sm btn-warning">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <li><a 
                                            ...
                                            href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform&form_id='.$row->fmb_id;?>">
