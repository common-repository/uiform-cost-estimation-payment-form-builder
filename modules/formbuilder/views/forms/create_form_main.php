                                                       ...
                                                       <!-- <li >
                                                        ...
                                                        <li>
                                                            <a 
                                                                ...
                                                                href="#uiform-settings-tab3-3" data-toggle="tab" ><?php echo __('Wizard','FRocket_admin'); ?>
                                                        ...
                                                        <li>
                                                            <a 
                                                                ...
                                                                href="#uiform-settings-tab3-4" data-toggle="tab" ><?php echo __('Summary Box','FRocket_admin'); ?></a></li>
                                                        <li>
                                                            <!--<a 
                                                                class=""
                                                                
                                                                href="#uiform-settings-tab3-5" data-toggle="tab" ><?php echo __('Unknown','FRocket_admin'); ?></a></li>-->
                                                    </ul>
