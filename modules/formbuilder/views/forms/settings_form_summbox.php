   ...
   <div class="row">
    ...
    <div class="row">
                <div class="col-sm-12">
                    ...
                    <label class="control-label" for=""><?php echo __('Variables','FRocket_admin'); ?>: <i>(<?php echo __('To be used in text content','FRocket_admin'); ?>)</i> </label>
                   
                        <div class="uifm-form-var-box">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              <!--  <li ><a href="#uiform-form-summ-vars-tab-1" data-toggle="tab"><?php echo __('Form','FRocket_admin'); ?></a></li>-->
                                <li class="active"><a href="#uiform-form-summ-vars-tab-2" data-toggle="tab" class="last-child"><?php echo __('General','FRocket_admin'); ?></a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                               <!-- <div class="tab-pane" id="uiform-form-summ-vars-tab-1">
                                ...
                                <div class="tab-pane in active" id="uiform-form-summ-vars-tab-2">
                                    <div class="uiform-tab-content2">
                                            ...
                                            <table class="table table-striped table-bordered table-condensed uifm-tab-box-vars-2">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><textarea onclick="this.select();">[uifm_symbol]</textarea></td>
                                                        
                                                    </tr>
                                                    <tr>
                                                        <td><?php echo __('Currency code', 'FRocket_admin'); ?></td>
                                                        <td><textarea onclick="this.select();">[uifm_currency]</textarea></td>
                                                        
                                                    </tr>
                                                    <tr>
                                                        <td><?php echo __('Total Amount price', 'FRocket_admin'); ?></td>
                                                        <td><textarea onclick="this.select();">[uifm_total]</textarea></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="controls form-group">
                                            <div class="btn-group btn-group-justified"
                                                ...
                                                <label 
                                                    ...
                                                    class="btn btn-warning uifm-fmsummbox-setoption-btn" >
