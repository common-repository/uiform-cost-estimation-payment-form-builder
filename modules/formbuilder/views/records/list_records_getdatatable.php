            ...
            <td>
                ...
                <li>
                    <a 
                        ...
                        href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=records&action=info_record&id_rec='.$value->fbh_id;?>"><i class="fa fa-pencil-square-o"></i> <?php echo __('Show detail','FRocket_admin');?></a></li>
                </ul>
            </div>
            </td>
        </tr>    
