                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <li><a 
                                            ...
                                            href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=gateways&controller=records&action=info_record&id_rec='.$row->fbh_id;?>">
                                            <i class="fa fa-pencil-square-o"></i> <?php echo __('Show','FRocket_admin')?></a></li>
                                    <li><a href="javascript:void(0);" 
                                           class="btn btn-danger"
                                           onclick="javascript:rocketform.invoice_delreg(this);"
