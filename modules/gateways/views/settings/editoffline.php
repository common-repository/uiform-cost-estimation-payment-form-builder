...
<div class="col-lg-12">
          <div class="widget widget-padding">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <input name="pg_name" 
                             ...
                             class="form-control col-md-7" value="<?php echo (isset($pg_name))?$pg_name:'';?>">
                    </div>
                  </div>
                    ...
                    <label class=" col-md-2 control-label"><?php echo __('Description','FRocket_admin')?></label>
                      <div class="col-md-10">
                        <textarea name="pg_description" 
                                  ...
                                  placeholder="" 
                                  class="form-control col-md-7"><?php echo $pg_description?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="widget-footer">
               <button type="submit" class="btn btn-primary" onclick="javascript:rocketform.gateway_saveoffline();"><?php echo __('Save','FRocket_admin')?></button>
               <button type="button" class="btn btn-default"  onclick="javascript:rocketform.gateway_gotoList();return false;" ><?php echo __('Cancel','FRocket_admin')?></button>
            </div>
          </div>
</div>
</div>
