      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform';?>"><?php echo __('New','FRocket_admin'); ?></a></li>
            ...
            <?php } ?>
            <li class="divider"></li>
            <li><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=forms&action=list_uiforms';?>"><?php echo __('List forms','FRocket_admin'); ?></a></li>
          </ul>
        </li>
        <?php if(isset($_GET['action']) && Uiform_Form_Helper::sanitizeInput($_GET['action'])==='create_uiform'){?>
        <li class="divider-menu"></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
              ...
              <li><a onclick="javascript:rocketform.templates_load(2);" 
                   href="javascript:void(0);"><?php echo __('Reservation Request Form','FRocket_admin'); ?><span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></a>
              </li>
              ...
              <li><a onclick="javascript:rocketform.templates_load(6);" 
                   href="javascript:void(0);"><?php echo __('Wedding planner','FRocket_admin'); ?><span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span></a>
              </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=records&action=list_records';?>">
                <?php echo __('List all Forms','FRocket_admin'); ?>
                </a>
            </li>
            <li><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=records&action=info_records_byforms';?>">
                <?php echo __('List by Form','FRocket_admin'); ?></a>
            </li>
            <li><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=records&action=custom_report';?>">
                <?php echo __('Custom Report','FRocket_admin'); ?></a>
            </li>
          </ul>
        </li>
        <li class="divider-menu"></li>
         <li ><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=gateways&controller=records&action=list_records';?>">
            <i class="fa fa-money"></i> <?php echo __('Invoices','FRocket_admin'); ?>
            </a>
        </li>
        <li class="divider-menu"></li>
        <li >
            <a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform&opt=import';?>">
                <i class="fa fa-reply"></i> <?php echo __('Import','FRocket_admin'); ?></a></li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=forms&action=export_form';?>">
            <i class="fa fa-share"></i> <?php echo __('Export','FRocket_admin'); ?></a></li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=records&action=view_charts';?>">
            <span class="fa fa-area-chart"></span> <?php echo __('Charts','FRocket_admin'); ?> 
            </a>
        </li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=settings&action=view_settings';?>">
            <i class="fa fa-cog"></i> <?php echo __('Settings','FRocket_admin'); ?>
            </a>
        </li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=formbuilder&controller=settings&action=backup_settings';?>">
        ...
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=uiform_cost_estimate&mod=gateways&controller=settings&action=view_settings';?>">
        ...
        <li class="divider-menu"></li>
        <li ><a href="http://codecanyon.net/item/uiform-wordpress-cost-estimation-payment-forms/13663682?ref=Softdiscover" class="rkfm-express-pro-button" target="_blank">
